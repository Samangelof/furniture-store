...
class CartItem(models.Model):
    product = models.ForeignKey('Mebels', on_delete=models.CASCADE, verbose_name='Продукт')
    quantity = models.PositiveIntegerField(default=1, verbose_name='Количество')
    user = models.ForeignKey('auths.CustomUser', on_delete=models.CASCADE, null=True, blank=True, verbose_name='Пользователь')
    ...
    def __str__(self):
        return f"{self}: {self.quantity} шт. {self.product.name}"
